import{d as g,o as s,c as r,a as e,h as y,F as h,e as c,u,n as x,t as a,r as M,E as b,_ as B}from"./index-Bg3n6gLm.js";const _={class:"mobile-orders-page"},m={class:"section-header"},j={class:"order-tabs"},V=["onClick"],H=["innerHTML"],L={class:"tab-label"},T={class:"order-types-list"},z=["onClick"],C=["innerHTML"],E={class:"item-label"},O=g({__name:"Orders",setup($){const n=u(),l=M("pending"),k=[{key:"pending",label:"待支付",icon:`<svg width="28" height="28" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"paid",label:"已支付",icon:`<svg width="28" height="28" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"waitlist",label:"候补订单",icon:`<svg width="28" height="28" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"mytickets",label:"本人车票",icon:`<svg width="28" height="28" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"invoice",label:"电子发票",icon:`<svg width="28" height="28" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`}],d=[{key:"food",label:"餐饮·特产订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"insurance",label:"保险订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"hotel",label:"酒店订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"airrail",label:"空铁联运订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"frequent",label:"计次·定期票订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"car",label:"租车·约车订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"business",label:"商务座服务订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"mall",label:"铁路商城订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"bus",label:"汽车票订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"tourism",label:"门票·旅游订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"trainwater",label:"铁水联运订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"ship",label:"船票订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`},{key:"pet",label:"宠物托运订单",icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    </svg>`}],v=()=>{n.push("/user")},w=i=>{l.value=i;const t={pending:"/orders/pending",paid:"/orders/paid",waitlist:"/orders/waitlist",mytickets:"/orders/mytickets"};t[i]&&n.push(t[i])},f=i=>{var t;b.info(`正在开发中：${(t=d.find(o=>o.key===i))==null?void 0:t.label}`)};return(i,t)=>(s(),r("div",_,[e("header",{class:"top-nav"},[e("button",{class:"back-btn",onClick:v},[...t[1]||(t[1]=[e("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"white","stroke-width":"2.5"},[e("polyline",{points:"15,18 9,12 15,6"})],-1)])]),t[2]||(t[2]=e("h1",{class:"nav-title"},"订单",-1)),t[3]||(t[3]=e("div",{class:"nav-placeholder"},null,-1))]),e("div",m,[t[4]||(t[4]=e("h2",{class:"section-title"},"火车票订单",-1)),e("a",{href:"#",onClick:t[0]||(t[0]=y(()=>{},["prevent"])),class:"tips-link"},"温馨提示")]),e("div",j,[(s(),r(h,null,c(k,o=>e("div",{key:o.key,class:x(["order-tab-item",{active:l.value===o.key}]),onClick:p=>w(o.key)},[e("div",{class:"tab-icon",innerHTML:o.icon},null,8,H),e("span",L,a(o.label),1)],10,V)),64))]),e("div",T,[(s(),r(h,null,c(d,o=>e("div",{key:o.key,class:"order-type-item",onClick:p=>f(o.key)},[e("div",{class:"item-icon",innerHTML:o.icon},null,8,C),e("span",E,a(o.label),1)],8,z)),64))])]))}}),N=B(O,[["__scopeId","data-v-1d9a1589"]]);export{N as default};
